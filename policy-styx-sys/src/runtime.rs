...
use wamr_rust_sdk::sys::{wasm_module_inst_t, wasm_module_t};

pub type PcdRuntimePointer = *mut u8; // Assuming a 64-bit pointer equivalent
pub type PcdModule = wasm_module_t; // Opaque type for `pcd_module_t`
pub type PcdInstance = wasm_module_inst_t; // Opaque type for `pcd_instance_t`
