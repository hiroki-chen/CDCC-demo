...
extern "C" int pcd_secret_register(pcd_identity_t *id, pcd_secret_t *input_secret) {
	std::pair<std::map<pcd_identity_t, pcd_secret_store_entry_t>::iterator,bool> ret;
	...
	ret = pcd_secret_store.insert(std::pair<pcd_identity_t, pcd_secret_store_entry_t>(*id, entry));
	if (ret.second == false) {
...
extern "C" int pcd_secret_fetch(pcd_identity_t *id, pcd_delegator_addr_t *delegator_addr, pcd_secret_t **output_secret) {
	std::map<pcd_identity_t, pcd_secret_store_entry_t>::iterator it;
	int status;
